...
--
-- Hôte : 127.0.0.1
-- Généré le :  mar. 21 juin 2022 à 15:48
...
INSERT INTO `produit` (`id`, `description`, `image`, `nom`, `prix`, `id_vendeur`) VALUES
(1, '64Go de Ram', 'png', 'Tecno', 1000, NULL),
(2, '256Go de Ram', 'png', 'Samsung', 20000, NULL);
...
('root', '[{\"db\":\"atostest\",\"table\":\"user\"},{\"db\":\"yemabox_db\",\"table\":\"easy_pay_login\"},{\"db\":\"yemabox_db\",\"table\":\"easy_pay_constant\"},{\"db\":\"yemabox_db\",\"table\":\"transaction\"},{\"db\":\"yemabox_db\",\"table\":\"yema_box_constant\"},{\"db\":\"yemabox_db\",\"table\":\"credit\"},{\"db\":\"yema_bd\",\"table\":\"slider\"},{\"db\":\"yema_bd\",\"table\":\"produit_en_solde\"},{\"db\":\"yema_bd\",\"table\":\"commande\"},{\"db\":\"yema_bd\",\"table\":\"produit\"}]');
